(function() {
    var mySection = $('script[src="js/h2streams.js"]').get(0).parentNode;
    var svgNode = $("svg",mySection).get(0);
    var transition = 300;
    var svg;
    var seqCount =0;
    var running = false;
    ...
    var transactions = [
        ...
        {
            name:'mux',
            description:'Multiple concurrent streams',
            data:[
        ...
        {
            name:'priority',
            description:'Stream Priority and flux control',
            data:[
    ...
    function update() {
        ...
        d3.select(".h2streams-demo .footer").html(transactions[currentTransaction].description)
    }

    Reveal.addEventListener( 'slidechanged', function( event ) {
        // event.previousSlide, event.currentSlide, event.indexh, event.indexv
        if (event.currentSlide == mySection) {
            svg.remove();
            render();
            update();
        }
